...
public class Enemy_4 : Enemy{
    ...
    void InitMovement(){
        ...
        // Assign a new on-screen locaiton to p1
        float widMinRad = bndCheck.camWidth - bndCheck.radius;
        float hgtMinRad = bndCheck.camHeight - bndCheck.radius;
        p1.x = Random.Range(-widMinRad, widMinRad);
        p1.y = Random.Range(-hgtMinRad, hgtMinRad);

        // Make sure that it moves ot a different quadrant of the screen
    ...
    public override void Move(){
        // This completely overrides Enemy.Move() with a linaer interpolation
        ...
        pos = (1 - u) * p0 + u * p1; // Simle linear interpolation
    }
    ...
    void OnCollisionEnter(Collision coll){
        ...
        if(p != null){
            ...
            if( bndCheck.isOnScreen){
                ...
                // // Only for spawning powerups which is not currenlty implemented
