...
public class EnemyShield : MonoBehaviour{
    ...
    /// <summary>
    /// Called by another EnenmyShield to oin the protectors of this EnemyShield
    /// </summary>
    ...
    /// <summary>
    /// Called by Enemy_4.OnCollisionEnter() & parent's EnemyShields.TakeDamate()
    ...
    public float TakeDamage(float dmg){
        ...
        foreach(EnemyShield es in protectors){
            if(es.isActive){
                ...
                // If all damage was handled, return 0 damaage
                if(dmg == 0) return 0;
            }
        }

        // If the code gets here, then this Enemy Shield will blink & take damage
